...
model = decompress_pickle('crdp.pbz2')
...
def main():
    ...
    PAY_1 = payment_status.index(st.selectbox(
        "Repayment Status of last month",
        tuple(payment_status)
    )) - 2
    
    PAY_2 = payment_status.index(st.selectbox(
        "Repayment Status of last 2nd month",
        tuple(payment_status)
    )) - 2
    
    PAY_3 = payment_status.index(st.selectbox(
        "Repayment Status of last 3rd month",
        tuple(payment_status)
    )) - 2
    
    PAY_4 = payment_status.index(st.selectbox(
        "Repayment Status of last 4th month",
        tuple(payment_status)
    )) - 2
    
    PAY_5 = payment_status.index(st.selectbox(
        "Repayment Status of last 5th month",
        tuple(payment_status)
    )) - 2
    
    PAY_6 = payment_status.index(st.selectbox(
        "Repayment Status of last 6th month",
        tuple(payment_status)
    )) - 2
